...
const fonts = configureFonts({
	config: {
		displaySmall: { fontFamily: 'inter-regular' },
		displayMedium: { fontFamily: 'inter-regular' },
		displayLarge: { fontFamily: 'inter-regular' },
		headlineSmall: { fontFamily: 'inter-bold' },
		headlineMedium: { fontFamily: 'inter-bold' },
		headlineLarge: { fontFamily: 'inter-bold' },
		titleSmall: { fontFamily: 'inter-bold' },
		titleMedium: { fontFamily: 'inter-bold' },
		titleLarge: { fontFamily: 'inter-bold' },
		labelSmall: { fontFamily: 'inter-regular' },
		labelMedium: { fontFamily: 'inter-regular' },
		labelLarge: { fontFamily: 'inter-regular' },
